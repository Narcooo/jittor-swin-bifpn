pretrained_weights = '/work_dirs/faster_rcnn_RoITrans_swint_fpn_1x_dota_1_' \
...
overlap = 256
ms = '1.0'
dataset_root = f'/home/lk/FAIR_dataset/preprocessed_FAIR1M_{overlap}'
dataset = dict(
    imgs_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        type=dataset_type,
        dataset_dir=f'{dataset_root}/trainval_1024_{overlap}_{ms}',
        # version='1',
        filter_min_size=32,
        transforms=[
            dict(
    ...
    val=dict(
        type=dataset_type,
        dataset_dir=f'{dataset_root}/val_1024_{overlap}_{ms}',
        # version='1',
        filter_min_size=32,
        transforms=[
            dict(
