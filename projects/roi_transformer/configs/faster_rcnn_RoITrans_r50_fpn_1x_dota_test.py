...
dataset = dict(
    ...
    train=dict(
        type=dataset_type,
        dataset_dir='/data/preprocessed_DOTA1/train_1024_256_1.0',
        version='1',
        filter_min_size=32,
        transforms=[
            dict(
    ...
    val=dict(
        type=dataset_type,
        dataset_dir='/data/preprocessed_DOTA1/val_1024_256_1.0',
        version='1',
        filter_min_size=32,
        transforms=[
            dict(
    ...
    test=dict(
        type="ImageDataset",        
        images_dir='/data/preprocessed_DOTA1/test_1024_200_1.0/images/',
        transforms=[
            dict(
                type = "Pad",
                size_divisor=32),
