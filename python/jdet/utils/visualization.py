...
from jdet.config.constant import DOTA1_CLASSES, DOTA2_CLASSES,DOTA_COLORS,FAIR1M_1_5_CLASSES
...
def visualize_dota_ground_truth(gt_dir, classnames, save_dir,style=0):
    ...
    for i in tqdm(range(len(names))):
        ...
        for data in datas:
            ...
            if len(ds) < 10:
                continue
            bboxes.append([int(float(i)) for i in ds[:8]])
            scores.append(1)
...
def main():
    gt_dir = "/data/preprocessed_DOTA2/val_1024_200_1.0"
    save_dir = "/data/vis_DOTA2/val"
    visualize_dota_ground_truth(gt_dir, DOTA2_CLASSES, save_dir, style=1)
