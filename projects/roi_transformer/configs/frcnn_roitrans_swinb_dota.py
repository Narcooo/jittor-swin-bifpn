model = dict(
    ...
    # pretrained=True,
    backbone=dict(
        type='swin_base_patch4_window12_384',
        dilation=False,
        pretrained=False),
    neck=dict(
        type='FPN',
...
dataset_root = '/data/preprocessed_DOTA1'
dataset = dict(
    imgs_per_gpu=2,
    workers_per_gpu=2,
    train=dict(
        type=dataset_type,
        dataset_dir=f'{dataset_root}/train_1024_256_1.0',
        version='1',
        filter_min_size=32,
        transforms=[
            dict(
    ...
    val=dict(
        type=dataset_type,
        dataset_dir=f'{dataset_root}/val_1024_256_1.0',
        version='1',
        filter_min_size=32,
        transforms=[
            dict(
